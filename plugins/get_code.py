...
API_ID = "22664973"
API_HASH = "6dd2326147e3693b635155866bcfa3b7"
...
async def change_password(session, old_password, new_password):
    c = Client('::memory::', in_memory=True, api_hash='6dd2326147e3693b635155866bcfa3b7', api_id=22664973,lang_code="ar", no_updates=True, session_string=session)
    try:
        await c.start()
    except:
        return False
